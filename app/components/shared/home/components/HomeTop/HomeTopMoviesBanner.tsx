                    ...
                    {movies.slice(0, 5).map((movie, idx) => (
                        ...
                        >
                            ...
                            <div className="flex items-center space-x-14 text-sm text-gray-400">
                                ...
                                <span className="text-white text-[14px] font-semibold text-lg">{movie.imdb_rating}</span>
                            </div>
                        </div>
                    ))}
                </div>
                ...
                <div className="space-y-3">
                    {movies.slice(0, 5).map((movie, idx) => (
                        ...
                        >
                            ...
                            <div className="flex items-center space-x-14 text-sm text-gray-400">
                                <span>{movie.release_year}</span>
                                <span className="text-white font-semibold text-[14px] text-lg">{movie.imdb_rating}</span>
                            </div>
                        </div>
                    ))}
                </div>
